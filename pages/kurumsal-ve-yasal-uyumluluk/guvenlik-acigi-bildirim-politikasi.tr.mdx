...
<Callout type="warning" title="Önemli — Hızlı özet">
  ...
  bildirin: **support@whoisnextapp.com** (tercihen şifreli/PGP). - **Sosyal
...
<Cards num={3}>
  ...
  >
    Kullanıcı güvenliği ve güvenli kullanım önerileri.
  </Card>
</Cards>
...
<details>
  ...
  <ul>
    ...
    <li>**API**: api.whoisnextapp.com, Google Firebase (EU) altyapısı</li>
    <li>**Mobil**: Apple App Store ve Google Play Store resmi sürümleri</li>
  </ul>
  <p>
    <strong>Test ortamları:</strong> Şu an için ayrı bir test/staging ortamı
    açık değildir; ileride açılması planlanabilir. Özel test gereksinimleriniz
    varsa, bildirim sırasında iletişim kurarak birlikte çözüm aranabilir.
  </p>
</details>
...
<Callout type="info" title="Güvenlik bildirim kanalları">
  - **E‑posta**: **support@whoisnextapp.com** — Hassas bilgiler için tercihen
  PGP ile şifreli iletişim önerilir. - **Kabul edilen diller**: Türkçe,
  İngilizce veya herhangi bir dilde rapor iletilebilir. - **Yapılandırılmış
  bildirim**: [Güvenlik Açığı Bildirim
  Formu](/basvuru-formlari/guvenlik-acigi-bildirim-formu) doldurulup tarayarak
  aynı adrese gönderilebilir. - **security.txt**: Araştırmacılar,
  [whoisnextapp.com](https://whoisnextapp.com)/.well-known/security.txt ve
  [legal.whoisnextapp.com](https://legal.whoisnextapp.com)/.well-known/security.txt
  adreslerinden politika ve iletişim bilgilerine erişebilir (RFC 9116).
</Callout>
...
>
  <Tab>
    **Teknik güvenlik açıkları** (yetkisiz erişim, veri ifşası, auth bypass vb.)
    için bu politika kapsamında **support@whoisnextapp.com** kanalını kullanın.
  </Tab>
  <Tab>
    Hesap erişimi, şifre sıfırlama ve genel destek için uygulama içi **Yardım**
    veya **İletişim** ekranlarını veya **support@whoisnextapp.com** kullanın
    (bkz. [Kullanım Koşulları](/sozlesmeler/kullanim-kosullari) İletişim
    bölümü).
  </Tab>
  <Tab>
    İçerik ihlali, taciz veya kişisel güvenlik şikayetleri için uygulama içi
    **Bildir** / **Şikayet Et** akışını kullanın; bkz. [Topluluk
    Kuralları](/topluluk-ve-guvenlik/topluluk-kurallari) ve [İçerik İhlal
    Formu](/basvuru-formlari/icerik-ihlal-formu).
  </Tab>
  <Tab>
    Mahkeme, savcılık veya kolluk talepleri için bkz. [Kolluk Kuvvetleri
...
<Callout type="info" title="Bu bölümün özeti">
  Bu bölüm, teşekkür ve ödül yaklaşımını açıklar. Ödüller zafiyetin etkisine
  göre değişebilir; detaylar için iletişim kurulabilir.
</Callout>
...
- **Ödül türleri**: Ödüller (örn. hediye deste, Premium avantajları veya benzeri bonuslar; hediye destelerin kullanımı için bkz. [Abonelik ve Satın Alma Koşulları](/sozlesmeler/abonelik-ve-satin-alma-kosullari) Bölüm 3.7) zafiyetin **şiddetine** ve **etkisine** göre değişebilir; her bulgu aynı derecede ödüllendirilmez.
...
- **Güvenlik açığı bildirimi:** **support@whoisnextapp.com** — [Güvenlik Açığı Bildirim Formu](/basvuru-formlari/guvenlik-acigi-bildirim-formu) doldurulup tarayarak aynı adrese gönderilebilir. Hassas bilgiler için tercihen PGP ile şifreli iletişim önerilir.
- **Genel destek / hesap:** Uygulama içi Yardım veya İletişim ekranları; **support@whoisnextapp.com** (bkz. [Kullanım Koşulları](/sozlesmeler/kullanim-kosullari) Bölüm 16.4).
- **Abonelik / ödeme:** **legal@whoisnextapp.com** (bkz. [Abonelik ve Satın Alma Koşulları](/sozlesmeler/abonelik-ve-satin-alma-kosullari)).
