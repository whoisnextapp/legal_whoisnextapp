...
<Callout type="warning" title="Önemli — Hızlı özet">
  ...
  **KVKK**, **TCK** (özellikle özel hayat/haberleşme gizliliği) ve **GDPR/DSA** çerçevesi ile uyumlu, “**iyi niyetli sorumlu açıklama
...
<Callout type="info" title="Güvenlik bildirim kanalları">
  - **E‑posta (tek kanal)**: **info@whoisnextapp.com**
  - **Kabul edilen diller**: Herhangi bir dilde (Türkçe, İngilizce vb.) rapor iletilebilir.
</Callout>
...
>
  <Tab>
    **Teknik güvenlik açıkları** (yetkisiz erişim, veri ifşası, auth bypass vb.) için bu politika kapsamında **info@whoisnextapp.com** kanalını kullanın.
  </Tab>
  <Tab>
    Mahkeme/savcılık/kolluk talepleri için bkz. [Kolluk Kuvvetleri Rehberi](/kurumsal-ve-yasal-uyumluluk/kolluk-kuvvetleri-rehberi).
  </Tab>
</Tabs>
...
Güvenlik açığı bildirimi için: **info@whoisnextapp.com**
