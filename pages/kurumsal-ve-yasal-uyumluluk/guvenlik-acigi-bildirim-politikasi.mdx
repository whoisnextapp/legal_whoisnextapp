...
<details>
  ...
  <p><strong>Test ortamları:</strong> Şu an için ayrı bir test/staging ortamı açık değildir; ileride açılması planlanabilir. Özel test gereksinimleriniz varsa, bildirim sırasında iletişim kurarak birlikte çözüm aranabilir.</p>
</details>
...
<Callout type="info" title="Güvenlik bildirim kanalları">
  - **E‑posta**: **info@whoisnextapp.com** — Hassas bilgiler için tercihen PGP ile şifreli iletişim önerilir.
  - **Kabul edilen diller**: Türkçe, İngilizce veya herhangi bir dilde rapor iletilebilir.
  ...
  - **security.txt**: Araştırmacılar, [whoisnextapp.com](https://whoisnextapp.com)/.well-known/security.txt ve [legal.whoisnextapp.com](https://legal.whoisnextapp.com)/.well-known/security.txt adreslerinden politika ve iletişim bilgilerine erişebilir (RFC 9116).
</Callout>
...
>
  ...
  <Tab>
    Hesap erişimi, şifre sıfırlama ve genel destek için uygulama içi **Yardım** veya **İletişim** ekranlarını veya **info@whoisnextapp.com** kullanın (bkz. [Kullanım Koşulları](/sozlesmeler/kullanim-kosullari) İletişim bölümü).
  </Tab>
  <Tab>
    İçerik ihlali, taciz veya kişisel güvenlik şikayetleri için uygulama içi **Bildir** / **Şikayet Et** akışını kullanın; bkz. [Topluluk Kuralları](/topluluk-ve-guvenlik/topluluk-kurallari) ve [İçerik İhlal Formu](/basvuru-formlari/icerik-ihlal-formu).
  </Tab>
  <Tab>
    Mahkeme, savcılık veya kolluk talepleri için bkz. [Kolluk Kuvvetleri Rehberi](/kurumsal-ve-yasal-uyumluluk/kolluk-kuvvetleri-rehberi).
  </Tab>
</Tabs>
...
<Callout type="info" title="Bu bölümün özeti">
  Bu bölüm, teşekkür ve ödül yaklaşımını açıklar. Ödüller zafiyetin etkisine göre
  değişebilir; detaylar için iletişim kurulabilir.
</Callout>
...
<Callout type="warning" title="Ödül uygunluğu (genel prensipler)">
  - Aynı zafiyeti **ilk bildiren** kişi/ekip önceliklidir.
  - Raporun **yeniden üretilebilir**, **etkiyi gösterir** ve **kapsam içi** olması gerekir.
  - Kural ihlali (otomasyon, veri kopyalama, şantaj vb.) ödül/teşekkür uygunluğunu ortadan kaldırabilir.
</Callout>
...
- **Güvenlik açığı bildirimi:** **info@whoisnextapp.com** — [Güvenlik Açığı Bildirim Formu](/basvuru-formlari/guvenlik-acigi-bildirim-formu) doldurulup tarayarak aynı adrese gönderilebilir. Hassas bilgiler için tercihen PGP ile şifreli iletişim önerilir.
- **Genel destek / hesap:** Uygulama içi Yardım veya İletişim ekranları; **info@whoisnextapp.com** (bkz. [Kullanım Koşulları](/sozlesmeler/kullanim-kosullari) Bölüm 16.4).
