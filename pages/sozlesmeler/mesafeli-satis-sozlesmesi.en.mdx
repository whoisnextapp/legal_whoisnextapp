...
The subject matter of the agreement is the **digital service** offered through the WIN mobile application. The main example is the **WIN Premium** subscription (weekly/monthly packages). One-off purchases (deck packs and Visibility Week), and any virtual items offered in the future, are also assessed under the same distance sales regime.
