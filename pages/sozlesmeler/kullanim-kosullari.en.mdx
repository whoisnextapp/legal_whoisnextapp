...
| **Deck / Card** | A set of 4 profile cards shown two at a time in the discovery feed; finishing a deck results in at most one pick. |
| **Match** | The possibility of communication that arises when the picked person starts the chat (there is no mutual-like mechanism). |
...
| **You Picked** | People you picked and added to your list when finishing a deck in the discovery feed (Deck). |
| **Picked You** | Users who picked you and added you to their “You Picked” list. Messaging starts from this list. |
...
Access to the account may be provided via **Google Sign-In (OAuth)**, **Sign in with Apple** (iOS devices only) or **sign-in with phone number** (SMS/OTP-based authentication). Data transferred through these routes is processed under the [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi) and [KVKK Privacy Notice](/gizlilik-ve-veri-koruma/kvkk-aydinlatma-metni).
...
**Google sign‑in:** The email address shared via your Google account is generally treated as **already verified** under Google’s processes. After profile creation, you may be directed in the app to **phone number verification** to make picks on the deck, send messages in chats and for similar interactions; this verification is **mandatory**.

**Sign in with Apple (iOS):** The technical user identifier Apple creates for your account, your email address (Apple's relay address if you use Apple's "Hide My Email" option) and, if you choose to share it, your name are used. After profile creation, **phone number verification** is mandatory here as well to make picks on the deck, send messages in chats and for similar interactions.

By your sign‑in method you accept that:

- You are authorised to use the relevant account (Google account, Apple ID or phone line),
- If you use Google or Apple, taking security measures for your account (password, device security, two-step verification, etc.) is your responsibility,
...
- You must keep your device, account tied to your sign-in method (Google, Apple or phone-based session), and app access secure; you must notify WIN without delay of suspicious activity.
...
- **Single device:** As a rule, your account can be signed in on only one device at a time. When someone signs in from another device, the account moves to that device and the session on the previous device is closed. The installation/device identifier used for this is described in Section 4.13 of the [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi).
...
Viewing profiles, being chosen, receiving notifications and messaging are free. Choosing is a paid feature: every account starts with at least 2 free decks; the free allowance and the WIN Premium subscription required to keep choosing once it has been used are set out in Section 3.7 of the [Subscription and Purchase Terms](/sozlesmeler/abonelik-ve-satin-alma-kosullari). Advanced features (e.g. deck filtering, profile hiding, score viewing) are also within WIN Premium.
...
- **Place of birth** (for the zodiac sign, natal chart and astrological compatibility features; the time of birth is optional and "I don't know" can be selected). Place and time of birth are not shown to other users on the profile screen; on their technical transmission for the astrological compatibility calculation see Section 4.5 of the [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi).
...
- For your profile to appear actively in the discovery feed, **as a rule at least one (1) photo must be verified**. WIN may, by administrator decision and in limited cases, grant an exception to this rule for certain accounts; it is therefore not guaranteed that every profile in the discovery feed is verified. Whether a photo is verified can be seen from the badge on it.
...
<Steps>
### 1. Permissions
Camera permission may be requested during the verification process; no audio is recorded during verification.
...
- **Dual Picking:** A deck consists of 4 profiles shown two at a time. Two different profile cards are shown; you choose one by double-tapping it. A new candidate opens next to the profile you chose and you are asked to choose again.
- **You Picked:** At the end of this flow, the last person you picked is added to your list as “You Picked”.
- **Picked You:** Users who chose you as “You Picked” appear on this list.
- **Messaging restriction:** To start a chat with a user, that person must have picked you and appear on your **“Picked You”** list. The picked person always decides whether to start the chat; making a pick does not guarantee a reply, a chat or a match.
...
**Premium benefits:**
Premium members may request: (i) continuing to choose after the free allowance has been used, (ii) **12 decks** that renew every 12 hours, (iii) appearing near the top of the “Picked You” list of the person they picked, (iv) priority access to newly joined profiles in decks, (v) the ability to filter decks, (vi) **hide profile**, (vii) seeing other members’ online/offline status, (viii) viewing their own scores and scores users gave to you/others (Intelligence, Politeness, Fun), (ix) sending voice messages, and (x) detailed astrological compatibility analysis. For the free allowance and the subscription requirement, see Section 3.7 of the [Subscription and Purchase Terms](/sozlesmeler/abonelik-ve-satin-alma-kosullari).
...
Situations such as not receiving replies to messages, picks not leading to a chat, or differences of opinion or identity are not generally treated as “breaches”.
...
- **Signals relating to profile quality/consistency** (e.g. missing fields, repeated behaviour patterns; a technical profile score based on how complete the profile is)
- **Newness and activity** (additional visibility given to newly joined profiles in their first days; whether a profile has been active recently)
- **Editorial selection** (profiles highlighted by the WIN team for a limited time) and **moderation decisions** (visibility reduced for a limited time or removal from the discovery feed)
- **Paid visibility** (WIN Premium and Visibility Week; see the [Subscription and Purchase Terms](/sozlesmeler/abonelik-ve-satin-alma-kosullari))

The deck is built by a **random draw** weighted by these signals; the weights increase or decrease the likelihood of a profile being shown but do not guarantee that it is shown. The detailed list of main parameters is in Section 12 of the [DSA Compliance Page](/kurumsal-ve-yasal-uyumluluk/dsa-uyum-sayfasi).
...
At this stage WIN sells the **WIN Premium subscription** and one-time **deck packs** and **Visibility Week** (see Section 3.5 of the [Subscription and Purchase Terms](/sozlesmeler/abonelik-ve-satin-alma-kosullari)). Package prices may **vary** according to market conditions; current prices are always shown on in-app purchase screens. There is no virtual currency, coin or credit purchasable in the app. Deck packs and promotional **gift decks** (achievement badges and the invite programme) are account-bound usage rights of a licence nature; they are non-assignable and not redeemable for cash. Which accounts can use gift decks without WIN Premium is set out in Section 3.7 of the [Subscription and Purchase Terms](/sozlesmeler/abonelik-ve-satin-alma-kosullari). If virtual currency or similar items are added in the future, refund and use terms will be additionally stated in the [Subscription and Purchase Terms](/sozlesmeler/abonelik-ve-satin-alma-kosullari).

---

## Section 9A: Advertisements and Third‑Party Content

**No ads are currently shown in the app.** The Google Mobile Ads (AdMob) software component is installed in the app, but no ad units are used. If **advertisements**, **promotions** or **sponsored content** (banners, video, etc.) provided by third parties are shown in the Services in the future, these Terms, the [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi) and the [Cookie Policy](/gizlilik-ve-veri-koruma/cerez-politikasi) will be updated accordingly and any required permissions will be requested separately. The Services may also include links to external websites/resources.

If ads are shown, WIN **does not endorse** such advertisements or third-party content; it is **not responsible** for the availability, accuracy, or content of third-party sites, resources, or products/services they offer. Your interaction with such content is subject to the third party's own terms of use and privacy policies. No guarantee is given that advertisements will always be shown or in a particular format; WIN reserves the right to change advertising models at any time.
...
Termination relating to your account may take two forms: **(i) deactivating (freezing) the account (turning off visibility)** and **(ii) deleting the account (permanent closure)**. In-app steps and legal consequences are detailed below (in particular **13.1.2 Deleting the account**).

#### 13.1.1 Deactivating (freezing) the account (turning off visibility)

If you wish, you may **deactivate (freeze)** your account without deleting it via **Settings > Deactivate Account** in the app. When the account is deactivated:

- Your profile is not shown to other users, is removed from the discovery feed (Deck) and nobody can pick you. Deactivation is different from simply signing out; when it is completed you are also signed out.
- Your **Picked You** and **You Picked** lists are cleared and your chats are removed from the other parties' message lists. When you reactivate your account these picks and chats **do not come back**. Removed chats are not deleted without being archived: their message records are moved to a legal archive with access limited to authorised staff; the voice message files in these chats are not deleted on deactivation and are moved to the same archive when their 30-day period expires (see Section 9 of the [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi)). The app shows this consequence as a separate warning before deactivation.
- You can reactivate your account when you sign in again; your profile information and photos are kept.
- Deactivation does not cancel a subscription purchased through a store (see 13.1.4) and does not automatically eliminate data retention and retention periods for legal obligations (see [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi) for details). The inactive-account rules in 13.3 remain applicable to deactivated accounts.

#### 13.1.2 Deleting the account (permanent closure)

You may delete your account by following **Settings > Delete Account** in the app (selecting a deletion reason and confirming). Account deletion is **irreversible** and has the following consequences:

- **Deletion starts immediately:** In current app versions deletion starts immediately after your confirmation; there is no waiting period. If deletion cannot be completed for a technical reason it is retried automatically by the system. If a deletion request with a 14-day waiting period was created from an older app version, you can cancel it or complete the deletion immediately by signing in again during that period.
- Your profile and visible areas linked to your account are closed to other users; your profile information, photos, verification selfies and sign-in record are deleted.
- **Not all data is deleted immediately:** a copy of the deleted account's profile record is kept for **90 days** and then deleted automatically; during account deletion chats are not deleted without archiving and are moved to a legal archive (voice messages removed from the chat 30 days after they are sent are also moved to the same archive); the ban record of banned accounts (including the phone number, the e-mail address where available and the reason for the ban) is kept unless the ban is lifted. Details and periods: Section 9 of the [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi) and Section 9 of the [KVKK Information Notice](/gizlilik-ve-veri-koruma/kvkk-aydinlatma-metni).
- In-app access to picks, messages, and similar records linked to your account ends.
...
- Retention and erasure of personal data are carried out under the [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi) (in particular Section 9: the 90-day account copy, the chat archive and the ban record) and Law No. 6698 (KVKK). Under KVKK, where processing grounds cease, data is erased/destroyed/anonymised; retention provisions in other laws remain reserved.
