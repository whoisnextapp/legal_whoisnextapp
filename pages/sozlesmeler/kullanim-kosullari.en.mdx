...
At this stage WIN sells the **WIN Premium subscription** and one-time **deck packs** and **Visibility Week** (see Section 3.5 of the [Subscription and Purchase Terms](/sozlesmeler/abonelik-ve-satin-alma-kosullari)). Package prices may **vary** according to market conditions; current prices are always shown on in‑app purchase screens. Virtual currency, credits, or spendable items purchasable in the app are of a licence nature; they are non‑assignable and not redeemable for cash. If such virtual items are added in the future, refund and use terms will be additionally stated in the [Subscription and Purchase Terms](/sozlesmeler/abonelik-ve-satin-alma-kosullari).
