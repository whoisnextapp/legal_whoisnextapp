...
<Callout type="warning" title="Important — Quick summary">
  ...
  - **Trial and virtual items:** **No free trial** is offered for WIN Premium. There is no virtual currency, coin or credit purchasable in the app. One-time purchased deck packs and Visibility Week, and promotional gift decks, are account-bound usage rights (see Sections 3.5–3.7).
  - **Choosing and the free allowance:** Viewing profiles, being chosen and chatting are free; choosing is a paid feature. For the free allowance and the subscription requirement, see Section 3.7.
...
| **One-time purchase** | Digital product purchased for a one-off fee independently of a subscription, which does not renew automatically (deck packs, Visibility Week). |
| **Deck** | A set of 4 profiles shown two at a time; a deck results in at most one pick. |
| **Gift deck** | A deck allowance credited to the account without payment for promotional purposes (through achievement badges or the invite programme); it has no monetary value. |
| **Virtual item**               | Purchasable digital items such as credits/coins; may be treated as a licence rather than a sale. Not currently offered in the app.        |
...
<Callout type="info" title="Summary of this section">
  This section explains the framework for WIN Premium scope, package options, promotions, one-off purchases, gift decks and the free allowance.
</Callout>
...
- **Continued choosing:** Ability to keep choosing after the free allowance (see Section 3.7) has been used,
...
- **Priority access to new profiles:** Priority access to newly joined profiles in decks.
- **Voice messages and astrology:** Sending voice messages and detailed astrological compatibility analysis.
...
**No free trial** is offered for WIN Premium. The subscription starts as a paid subscription upon your purchase confirmation.
...
In addition to the WIN Premium subscription, one-time (consumable) purchases are offered through the stores: **deck packs** (1 / 2 / 4 decks) and **Visibility Week**. These products are not subscriptions and do not renew automatically; the price and conditions shown on the purchase screen and this text apply.

- **Deck packs:** The number of decks purchased is added to your account balance. Deck packs are offered on the screen shown when your 12-hour deck allowance runs out; which packs are shown there may change. Purchased decks are used once your 12-hour deck allowance (or your free allowance) is exhausted, can be used without a WIN Premium subscription until they are used up, and have no separate expiry date. A deck results in at most one pick; a purchase does not guarantee that the chosen person will reply or start a conversation.
- **Visibility Week:** For **7 days** from the moment of purchase, your profile takes part in deck draws with a higher weight (×2). If purchased again during that period, the period is extended by 7 days. Visibility Week does not give any right to pick or any deck allowance and does not guarantee any number of views, being picked, messages or conversations.
- Purchased decks and Visibility Week are tied to your account; they cannot be transferred to another account or exchanged for cash. For the use of the purchased deck balance, see also Section 3.7.

### 3.6 Virtual items

There are **no** purchasable virtual-currency items such as “coin/diamond/credit” in the app. If such virtual items are offered later, the provisions in Section 10 apply. The deck packs and Visibility Week in Section 3.5, the free deck allowance in Section 3.7 and **gift decks** are usage rights tied to the account; they cannot be transferred to another account or exchanged for cash. Gift decks are promotional; they have no monetary value and are not refundable.

### 3.7 Free allowance and the subscription requirement for choosing

Viewing profiles, being chosen, receiving notifications and messaging are provided free of charge. Choosing (finishing a deck and making a pick) is a paid feature. A "deck" is a set of 4 profiles shown two at a time; finishing a deck results in at most one pick.

Each account receives a one-time free allowance of 2 decks. The allowance is counted over the lifetime of the account and does not renew. Decks used before app version 1.0.63 may also count toward it, including decks that were skipped without a pick on app versions earlier than 1.0.63. We may give some accounts a larger free allowance at our discretion; the products, prices and benefits of WIN Premium are the same for everyone.

Once the free allowance has been used, an active WIN Premium subscription is required to keep choosing. Deck packs bought as one-time purchases remain valid and can be used without a subscription until they are used up.

**Gift decks:** Gift decks earned without payment (through achievement badges or the invite programme) are promotional and have no monetary value. **If your account is subject to the lifetime free allowance in this section**, gift decks can be used only while your WIN Premium subscription is active; on accounts not subject to it, gift decks can also be used without a subscription. While gift decks are usable, they are spent from your balance before the decks you purchased.

**Invite programme:** Your friend downloads Who is Next, enters your invite code in the app on the **Settings > Invite Friends** screen, and once their account is verified (photo verification completed) you both receive **+5 gift decks**. An inviting account is rewarded for at most 20 invites. You cannot use your own code and each account can use only one invite code; WIN may withhold the reward where abuse is suspected. Depending on your account, WIN Premium may be required to use gift decks (see the paragraph above).

A subscription gives continued access to choosing. It does not guarantee that a chosen person will reply, start a conversation or match with you. The chosen person always decides whether to start the conversation.

This rule applies to app version 1.0.63 (build 117) and later and takes effect when that version is released.
...
During WIN account deletion, if you have an active subscription the application additionally warns you about subscription cancellation. In current app versions account deletion starts immediately after your confirmation and cannot be undone; for records retained about deleted accounts see Section 9 of the [Privacy Policy](/gizlilik-ve-veri-koruma/gizlilik-politikasi). Deleting the account does not cancel the subscription; responsibility for cancelling the subscription remains with the user.
...
<Callout type="info" title="Summary of this section">
  One-time purchases (deck packs, Visibility Week) are governed by Section 3.5 and gift decks by Section 3.7; this section sets out the general framework applying to them and to any virtual items that may be added later.
</Callout>
