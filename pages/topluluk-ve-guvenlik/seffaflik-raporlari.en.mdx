...
<Callout type="info" title="First reporting period">
  **First reporting period:** The application is available in the stores (App Store and Google Play); however, because the first reporting period has not yet been completed, no transparency report has been published so far. The first transparency report will be published at the end of the first calendar year following full-capacity release of the application. Reports will be prepared in **Turkish** and **English**.
</Callout>
...
If there is an EU target, the **average monthly active recipients** within the EU over the past six months (under Art. 24(2) DSA) will be published. This information will be shared on this page and on the [DSA Compliance Page](/kurumsal-ve-yasal-uyumluluk/dsa-uyum-sayfasi) when its publication is required.
