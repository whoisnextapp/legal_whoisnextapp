...
<Callout type="info" title="You do not have to like someone">
  Reporting someone just because they are “not a match” for you is not appropriate. If they are not a match, do not pick them, remove the match, or block them. Reporting should be used for **rule violations**.
</Callout>
