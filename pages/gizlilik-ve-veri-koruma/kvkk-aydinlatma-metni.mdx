...
<Cards num={3}>
  ...
  <Card title="KVKK Başvuru Formu" href="/basvuru-formlari/kvkk-basvuru-formu">
    KVKK m. 11 kapsamındaki haklarınızı kullanmak için başvuru formu ve iletişim.
  </Card>
  <Card title="Yasa Dışı İçerik Bildirim Formu" href="/basvuru-formlari/yasa-disi-icerik-bildirim-formu">
    Resmî makamların 5651/DSA kapsamında yasa dışı içerik bildirimi için kullanacağı form.
  </Card>
</Cards>
...
<Tabs items={["Onboarding & Profil", "Doğrulama", "Eşleşme & Mesajlaşma", "Premium & Ödeme", "Ziyaretçi & Çerez/SDK", "Destek & Şikayet"]}>
  ...
  <Tab>
    ...
    - **Biyometrik doğrulama:** Sahte hesapları önlemek amacıyla kamera aracılığıyla çekilen liveness/pose selfie'si ve yüz karşılaştırma (**Amazon Rekognition - CompareFaces**) işlemleri. Keşif akışında (Deck) yer alabilmek için en az bir fotoğrafın bu yöntemle doğrulanmış olması zorunludur. Doğrulanan fotoğraflarda yeşil tik/rozet gösterilir.
...
**Premium Ayrıcalığı:** Premium paket sahipleri, profillerini tamamen gizleme (**hide profile**) özelliğini kullanarak görünürlüklerini kontrol edebilirler; ileri düzey deck filtreleri kullanabilirler; kendi puanlarını ve diğerlerinin puanlarını görebilirler; kullanıcıların çevrim içi durumunu izleyebilirler. Free (ücretsiz) kullanıcılar için bu özellikler sunulmamaktadır.
