...
<Callout type="warning" title="Önemli — Kısa özet (katmanlı bilgilendirme)">
  ...
  bir kısmı diğer kullanıcılara görünür hâle gelebilir. 
  - **Hassas alanlar:** Selfie/liveness doğrulaması (**biyometrik değerlendirme riski**), konum verisi
  ...
  **açık rıza** kurgusu benimsenir. 
  - **Üçüncü taraflar:** Platform; barındırma, güvenlik, analitik, bildirim, ödeme ve doğrulama gibi amaçlarla hizmet
  sağlayıcılarla çalışabilir. Bazı sağlayıcılar **veri işleyen**, bazıları
  **bağımsız veri sorumlusu** olabilir. 
  - **Haklarınız:** KVKK m. 11 kapsamındaki haklarınızı kullanabilirsiniz; başvuru yolları ve kimlik
