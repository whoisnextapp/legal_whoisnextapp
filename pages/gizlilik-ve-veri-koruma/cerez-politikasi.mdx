...
Bu politika kapsamındaki çerez/izleme faaliyetleri bakımından veri sorumlusu, WIN Hizmetlerinin işletmecisidir: **WIN TECH Bilişim Organizasyon ve Ticaret A.Ş.** Veri sorumlusu iletişim bilgileri ve KVKK kapsamındaki başvuru yöntemleri için [KVKK Aydınlatma Metni](/gizlilik-ve-veri-koruma/kvkk-aydinlatma-metni) incelenmelidir. Her türlü soru için **info@whoisnextapp.com** adresi üzerinden bizimle iletişime geçebilirsiniz.
