...
WIN TECH BİLİŞİM VE ORGANİZASYON TİC. A.Ş. tarafından; Platforma ilişkin kampanya, promosyon, duyuru ve tanıtımlar hakkında; **SMS** (Twilio üzerinden), **E-posta** (info@whoisnextapp.com üzerinden) ve **Pazarlama Push Bildirimleri** kanalları üzerinden ticari elektronik ileti gönderilmesine **onay veriyorum**.
